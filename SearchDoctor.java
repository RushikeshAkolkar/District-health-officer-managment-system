...
public class SearchDoctor extends JFrame implements ActionListener {  
    //Initializing Components  
        ...
        //Creating Constructor for initializing JFrame components  
            public SearchDoctor(String s2,String s3) {  
            //Providing Title 
            super("Fetching Doctor in Hospital Information");  
            lb5 = new JLabel("Doctor Name:");  
            ...
            tf8.setBounds(550,20,100,20);
            
            btn = new JButton("Submit");  
            btn.setBounds(240, 50, 100, 20);  
            btn.addActionListener(this);  
            lb = new JLabel("Fetching Doctor in Hospital Information From Database");  
            ...
            b2=new JButton("Register Doctor");
        ...
        public void actionPerformed(ActionEvent ex) {  
            ...
            Class.forName("org.postgresql.Driver");  
                Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres","postgres", "123"); 
                 PreparedStatement st = con.prepareStatement("select * from doctor where did=? and dname=?");  
                st.setInt(1, str3);
                st.setString(2, str);
